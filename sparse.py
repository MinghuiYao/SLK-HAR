...
def SNIP(net, keep_ratio, train_dataloader, device, masks):
...
class Masking(object):
    def __init__(self, optimizer, train_loader, prune_rate_decay, prune_rate=0.01, prune_mode='magnitude', growth_mode='random', redistribution_mode='momentum', verbose=False, fp16=False):
    ...
    def add_module(self, module):
        ...
        self.init(mode= 'snip', density=0.6)
    ...
    def init(self, mode='snip', density=0.04, erk_power_scale=1.0):
        ...
        if mode == 'uniform':
            ...
            self.baseline_nonzero = 0
            layer_wise_sparsities = SNIP(self.module, density, self.train_loader, self.device, self.masks)
